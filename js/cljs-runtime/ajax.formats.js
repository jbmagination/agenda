...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__28832){
var map__28833 = p__28832;
var map__28833__$1 = ((((!((map__28833 == null)))?(((((map__28833.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28833.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28833):map__28833);
var request = map__28833__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28833__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__28838 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__28838.cljs$core$IFn$_invoke$arity$1 ? fexpr__28838.cljs$core$IFn$_invoke$arity$1(response) : fexpr__28838.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__28840 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__28840.cljs$core$IFn$_invoke$arity$1 ? fexpr__28840.cljs$core$IFn$_invoke$arity$1(response) : fexpr__28840.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__28843){
...
var request = map__28846__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28846__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
