...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k27843,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k27843,else__4206__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__27842){
var self__ = this;
var G__27842__$1 = this;
return (new cljs.core.RecordIter((0),G__27842__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4061__auto____$1 = (function (){var fexpr__27884 = ((function (h__4061__auto__,this__4199__auto____$1){
return (function (coll__4200__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4200__auto__));
});})(h__4061__auto__,this__4199__auto____$1))
;
return fexpr__27884(this__4199__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this27844,other27845){
var self__ = this;
var this27844__$1 = this;
return ((!((other27845 == null))) && ((this27844__$1.constructor === other27845.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27844__$1.status,other27845.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27844__$1.body,other27845.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27844__$1.status_text,other27845.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27844__$1.headers,other27845.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27844__$1.was_aborted,other27845.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27844__$1.__extmap,other27845.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__27842){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__27934 = cljs.core.keyword_identical_QMARK_;
var expr__27935 = k__4211__auto__;
if(cljs.core.truth_((function (){var G__27937 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__27938 = expr__27935;
return (pred__27934.cljs$core$IFn$_invoke$arity$2 ? pred__27934.cljs$core$IFn$_invoke$arity$2(G__27937,G__27938) : pred__27934.call(null,G__27937,G__27938));
})())){
return (new ajax.protocols.Response(G__27842,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__27939 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__27941 = expr__27935;
return (pred__27934.cljs$core$IFn$_invoke$arity$2 ? pred__27934.cljs$core$IFn$_invoke$arity$2(G__27939,G__27941) : pred__27934.call(null,G__27939,G__27941));
})())){
return (new ajax.protocols.Response(self__.status,G__27842,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__27942 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__27943 = expr__27935;
return (pred__27934.cljs$core$IFn$_invoke$arity$2 ? pred__27934.cljs$core$IFn$_invoke$arity$2(G__27942,G__27943) : pred__27934.call(null,G__27942,G__27943));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__27842,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__27944 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__27945 = expr__27935;
return (pred__27934.cljs$core$IFn$_invoke$arity$2 ? pred__27934.cljs$core$IFn$_invoke$arity$2(G__27944,G__27945) : pred__27934.call(null,G__27944,G__27945));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__27842,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__27946 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__27947 = expr__27935;
return (pred__27934.cljs$core$IFn$_invoke$arity$2 ? pred__27934.cljs$core$IFn$_invoke$arity$2(G__27946,G__27947) : pred__27934.call(null,G__27946,G__27947));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__27842,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4211__auto__,G__27842),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__27842){
var self__ = this;
var this__4202__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__27842,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__27849){
var extmap__4236__auto__ = (function (){var G__27965 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__27849,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__27849),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__27849),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__27849),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__27849),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__27849),null,cljs.core.not_empty(extmap__4236__auto__),null));
});
