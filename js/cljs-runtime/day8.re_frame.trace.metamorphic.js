goog.provide('day8.re_frame.trace.metamorphic');
goog.require('cljs.core');
/**
 * Returns a transducer that filters for :id between beginning and ending. Inclusive on both ends.
 */
day8.re_frame.trace.metamorphic.id_between_xf = (function day8$re_frame$trace$metamorphic$id_between_xf(beginning,ending){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__20493_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__20493_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__20493_SHARP_) <= ending)));
}));
});
day8.re_frame.trace.metamorphic.fsm_trigger_QMARK_ = (function day8$re_frame$trace$metamorphic$fsm_trigger_QMARK_(event){
...
day8.re_frame.trace.metamorphic.elapsed_time = (function day8$re_frame$trace$metamorphic$elapsed_time(ev1,ev2){
...
return Math.round((end_of_epoch - start_of_epoch));
} else {
return null;
}
});
day8.re_frame.trace.metamorphic.run_queue_QMARK_ = (function day8$re_frame$trace$metamorphic$run_queue_QMARK_(event){
var and__3938__auto__ = day8.re_frame.trace.metamorphic.fsm_trigger_QMARK_(event);
...
day8.re_frame.trace.metamorphic.request_animation_frame_QMARK_ = (function day8$re_frame$trace$metamorphic$request_animation_frame_QMARK_(event){
...
day8.re_frame.trace.metamorphic.request_animation_frame_end_QMARK_ = (function day8$re_frame$trace$metamorphic$request_animation_frame_end_QMARK_(event){
...
day8.re_frame.trace.metamorphic.summarise_event = (function day8$re_frame$trace$metamorphic$summarise_event(ev){
...
day8.re_frame.trace.metamorphic.summarise_match = (function day8$re_frame$trace$metamorphic$summarise_match(match){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(day8.re_frame.trace.metamorphic.summarise_event,match);
});
day8.re_frame.trace.metamorphic.beginning_id = (function day8$re_frame$trace$metamorphic$beginning_id(match){
return new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.first(match));
});
day8.re_frame.trace.metamorphic.ending_id = (function day8$re_frame$trace$metamorphic$ending_id(match){
return new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.last(match));
});
day8.re_frame.trace.metamorphic.add_event_from_idle_QMARK_ = (function day8$re_frame$trace$metamorphic$add_event_from_idle_QMARK_(event){
...
day8.re_frame.trace.metamorphic.subscription_QMARK_ = (function day8$re_frame$trace$metamorphic$subscription_QMARK_(trace){
...
day8.re_frame.trace.metamorphic.subscription_created_QMARK_ = (function day8$re_frame$trace$metamorphic$subscription_created_QMARK_(trace){
...
day8.re_frame.trace.metamorphic.subscription_re_run_QMARK_ = (function day8$re_frame$trace$metamorphic$subscription_re_run_QMARK_(trace){
...
day8.re_frame.trace.metamorphic.subscription_destroyed_QMARK_ = (function day8$re_frame$trace$metamorphic$subscription_destroyed_QMARK_(trace){
...
day8.re_frame.trace.metamorphic.subscription_not_run_QMARK_ = (function day8$re_frame$trace$metamorphic$subscription_not_run_QMARK_(trace){
return false;
});
/**
 * Is this part of re-frame internals?
 */
day8.re_frame.trace.metamorphic.low_level_re_frame_trace_QMARK_ = (function day8$re_frame$trace$metamorphic$low_level_re_frame_trace_QMARK_(trace){
var G__20500 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
 ...
 */
day8.re_frame.trace.metamorphic.low_level_reagent_trace_QMARK_ = (function day8$re_frame$trace$metamorphic$low_level_reagent_trace_QMARK_(trace){
...
day8.re_frame.trace.metamorphic.render_QMARK_ = (function day8$re_frame$trace$metamorphic$render_QMARK_(trace){
...
day8.re_frame.trace.metamorphic.unchanged_l2_subscription_QMARK_ = (function day8$re_frame$trace$metamorphic$unchanged_l2_subscription_QMARK_(sub){
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__20501_SHARP_);
});})(and__3938__auto__))
...
day8.re_frame.trace.metamorphic.finish_run_QMARK_ = (function day8$re_frame$trace$metamorphic$finish_run_QMARK_(event){
var and__3938__auto__ = day8.re_frame.trace.metamorphic.fsm_trigger_QMARK_(event);
if(cljs.core.truth_(and__3938__auto__)){
...
day8.re_frame.trace.metamorphic.event_run_QMARK_ = (function day8$re_frame$trace$metamorphic$event_run_QMARK_(event){
 ...
 */
day8.re_frame.trace.metamorphic.start_of_epoch_QMARK_ = (function day8$re_frame$trace$metamorphic$start_of_epoch_QMARK_(event){
var or__3949__auto__ = day8.re_frame.trace.metamorphic.run_queue_QMARK_(event);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
return day8.re_frame.trace.metamorphic.event_run_QMARK_(event);
}
});
/**
 ...
 *   own epoch.
 */
day8.re_frame.trace.metamorphic.start_of_epoch_and_prev_end_QMARK_ = (function day8$re_frame$trace$metamorphic$start_of_epoch_and_prev_end_QMARK_(event,state){
var or__3949__auto__ = day8.re_frame.trace.metamorphic.run_queue_QMARK_(event);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var and__3938__auto__ = day8.re_frame.trace.metamorphic.event_run_QMARK_(event);
if(cljs.core.truth_(and__3938__auto__)){
return cljs.core.not(day8.re_frame.trace.metamorphic.run_queue_QMARK_(new cljs.core.Keyword(null,"previous-event","previous-event",-726928509).cljs$core$IFn$_invoke$arity$1(state)));
} else {
return and__3938__auto__;
}
}
});
day8.re_frame.trace.metamorphic.quiescent_QMARK_ = (function day8$re_frame$trace$metamorphic$quiescent_QMARK_(event){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(((no_match_QMARK_)?(cljs.core.truth_(day8.re_frame.trace.metamorphic.start_of_epoch_QMARK_(event))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"current-match","current-match",-551498177),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [event], null)):state):(cljs.core.truth_(day8.re_frame.trace.metamorphic.quiescent_QMARK_(event))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"partitions","partitions",602979514),cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_match,event)),new cljs.core.Keyword(null,"current-match","current-match",-551498177),null):(cljs.core.truth_(day8.re_frame.trace.metamorphic.start_of_epoch_and_prev_end_QMARK_(event,state))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"partitions","partitions",602979514),cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_match,previous_event)),new cljs.core.Keyword(null,"current-match","current-match",-551498177),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [event], null)):(cljs.core.truth_(day8.re_frame.trace.metamorphic.event_run_QMARK_(event))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"current-match","current-match",-551498177),cljs.core.conj,event):state
)))),new cljs.core.Keyword(null,"previous-event","previous-event",-726928509),event);
}),parse_state,traces);
});
day8.re_frame.trace.metamorphic.matched_event = (function day8$re_frame$trace$metamorphic$matched_event(match){
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(day8.re_frame.trace.metamorphic.event_run_QMARK_,match));
});
/**
 * Collect information about the subscription that we'd like
 *   to know, like its layer.
 */
day8.re_frame.trace.metamorphic.subscription_info = (function day8$re_frame$trace$metamorphic$subscription_info(initial_state,filtered_traces,app_db_id){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (state,trace){
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__20510_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__20510_SHARP_);
...
}),initial_state,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(day8.re_frame.trace.metamorphic.subscription_re_run_QMARK_,filtered_traces));
});
/**
 * Remove information about the subscription that is transient and specific to a single
 *   phase.
 */
day8.re_frame.trace.metamorphic.reset_sub_state = (function day8$re_frame$trace$metamorphic$reset_sub_state(state){
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__20515){
...
day8.re_frame.trace.metamorphic.process_sub_traces = (function day8$re_frame$trace$metamorphic$process_sub_traces(initial_state,traces){
...
var new_state = (function (){var G__20519 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,reaction_id,((function (G__20519,G__20519__$1,tags,reaction_id,state){
...
});})(G__20519,G__20519__$1,tags,reaction_id,state))
);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20519__$1)].join('')));
...
return (function (all_state,p__20523){
var vec__20524 = p__20523;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20524,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20524,(1),null);
 ...
 */
day8.re_frame.trace.metamorphic.subscription_match_state = (function day8$re_frame$trace$metamorphic$subscription_match_state(sub_state,filtered_traces,new_matches){
...
var pre_epoch_traces = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(day8.re_frame.trace.metamorphic.id_between_xf((previous_id + (1)),(first_match_id - (1))),cljs.core.filter.cljs$core$IFn$_invoke$arity$1(day8.re_frame.trace.metamorphic.subscription_QMARK_)),filtered_traces);
var epoch_traces = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(day8.re_frame.trace.metamorphic.id_between_xf(first_match_id,last_match_id),cljs.core.filter.cljs$core$IFn$_invoke$arity$1(day8.re_frame.trace.metamorphic.subscription_QMARK_)),filtered_traces);
...
var pre_epoch_state = day8.re_frame.trace.metamorphic.process_sub_traces(day8.re_frame.trace.metamorphic.reset_sub_state(reaction_state),pre_epoch_traces);
var epoch_state = day8.re_frame.trace.metamorphic.process_sub_traces(day8.re_frame.trace.metamorphic.reset_sub_state(pre_epoch_state),epoch_traces);
...
//# sourceMappingURL=day8.re_frame.trace.metamorphic.js.map
