...
var G__20313 = new cljs.core.Keyword(null,"end","end",-268185958);
var G__20314 = string;
return (n.cljs$core$IFn$_invoke$arity$2 ? n.cljs$core$IFn$_invoke$arity$2(G__20313,G__20314) : n.call(null,G__20313,G__20314));
});
...
break;
case (2):
return day8.re_frame.trace.utils.pretty_print_condensed.truncate_string.cljs$core$IFn$_invoke$arity$3(n,new cljs.core.Keyword(null,"start","start",-355208981),string);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__20317 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20315__$1)].join('')));
...
return day8.re_frame.trace.utils.pretty_print_condensed.truncate_segments.cljs$core$IFn$_invoke$arity$4(s,limit,/^[^.]+\./,"\u2026");
});
...
var G__20353 = clojure.string.replace(s,match,trunc_prefix);
var G__20354 = limit;
var G__20355 = match;
var G__20356 = trunc_prefix;
s = G__20353;
limit = G__20354;
match = G__20355;
trunc_prefix = G__20356;
continue;
}
}
break;
...
var prefix = (function (){var G__20321 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20321),"\u2026/"].join('');
} else {
return G__20321;
}
})();
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(prefix),cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame.trace.utils.pretty_print_condensed.truncate_string.cljs$core$IFn$_invoke$arity$3((n - cljs.core.count(prefix)),new cljs.core.Keyword(null,"start","start",-355208981),the_name))].join('');
} else {
...
var ns_string = day8.re_frame.trace.utils.pretty_print_condensed.truncate_segments.cljs$core$IFn$_invoke$arity$2(the_ns,ns_budget);
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(day8.re_frame.trace.utils.pretty_print_condensed.truncate_named((12),new cljs.core.Keyword("city","saskatoon","city/saskatoon",2120611420)),":\u2026/saskatoon")){
} else {
...
return day8.re_frame.trace.utils.pretty_print_condensed.truncate_named(n,param);
} else {
return day8.re_frame.trace.utils.pretty_print_condensed.truncate_string.cljs$core$IFn$_invoke$arity$3(n,location,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(param)].join(''));
}
});
...
var vec__20329 = day8.re_frame.trace.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20329,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20329,(1),null);
...
return day8.re_frame.trace.utils.pretty_print_condensed.pretty_condensed.cljs$core$IFn$_invoke$arity$4((0),cljs.core.coll_QMARK_,(1),form);
});
...
return day8.re_frame.trace.utils.pretty_print_condensed.truncate_named((16),form);
} else {
if(typeof form === 'string'){
return day8.re_frame.trace.utils.pretty_print_condensed.truncate_string.cljs$core$IFn$_invoke$arity$3((16),new cljs.core.Keyword(null,"middle","middle",-701029031),form);
} else {
if(cljs.core.fn_QMARK_(form)){
var or__3949__auto__ = (function (){var G__20344 = form.name;
if((G__20344 == null)){
return null;
} else {
return clojure.string.replace(G__20344,/(^.*\$)(.*)/,"$2");
}
})();
...
return day8.re_frame.trace.utils.pretty_print_condensed.with_edges(form,clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$4(day8.re_frame.trace.utils.pretty_print_condensed.pretty_condensed,(depth + (1)),enter_pred,max_depth),form)));
} else {
return day8.re_frame.trace.utils.pretty_print_condensed.with_edges(form,"\u2026");
...
//# sourceMappingURL=day8.re_frame.trace.utils.pretty_print_condensed.js.map
