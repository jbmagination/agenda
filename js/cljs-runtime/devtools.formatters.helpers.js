...
var G__13851 = devtools.prefs.pref(v);
v = G__13851;
continue;
} else {
return v;
...
var and__3938__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__3938__auto__){
var and__3938__auto____$1 = !(cljs.core.var_QMARK_(value));
...
}catch (e13744){var _e__12604__auto__ = e13744;
return false;
}})();
...
}catch (e13755){var _e__12604__auto__ = e13755;
return false;
}})();
...
}catch (e13760){var _e__12604__auto__ = e13760;
return false;
}}
}
});
...
var and__3938__auto____$1 = cljs.core.not(devtools.formatters.helpers.is_prototype_QMARK_(f));
if(and__3938__auto____$1){
...
var or__3949__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
var and__3938__auto__ = (function (){var or__3949__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
var vec__13785 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13785,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13785,(1),null);
...
var and__3938__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__3938__auto__)){
...
return cljs.core.some((function (p1__13806_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13806_SHARP_);
}),template);
});
...
var temp__5455__auto__ = devtools.formatters.helpers.pref(pref_key);
if(cljs.core.truth_(temp__5455__auto__)){
