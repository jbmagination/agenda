...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13856){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13915_SHARP_){
return !((cljs.core.meta(p1__13915_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13937__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13945){var _e__12604__auto__ = e13945;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e13950){var _e__12604__auto__ = e13950;
return false;
}}
})())){
...
var _STAR_current_state_STAR_13955 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state();

try{var map__13956 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13956__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_13955;
}});
...
;
var temp__5455__auto___14050 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___14050)){
var managed_print_level_14051 = temp__5455__auto___14050;
var _STAR_print_level_STAR_13970_14052 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_14051;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR_13970_14052,managed_print_level_14051,temp__5455__auto___14050,writer,opts,job_fn){
return (function (p1__13962_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13962_SHARP_,null);
});})(_STAR_print_level_STAR_13970_14052,managed_print_level_14051,temp__5455__auto___14050,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_13970_14052;
}} else {
job_fn();
}
