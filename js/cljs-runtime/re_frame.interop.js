...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__20664 = cljs.core.instance_QMARK_;
var expr__20665 = reactive_val;
if(cljs.core.truth_((pred__20664.cljs$core$IFn$_invoke$arity$2 ? pred__20664.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__20665) : pred__20664.call(null,reagent.ratom.RAtom,expr__20665)))){
return "ra";
} else {
if(cljs.core.truth_((pred__20664.cljs$core$IFn$_invoke$arity$2 ? pred__20664.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__20665) : pred__20664.call(null,reagent.ratom.RCursor,expr__20665)))){
return "rc";
} else {
if(cljs.core.truth_((pred__20664.cljs$core$IFn$_invoke$arity$2 ? pred__20664.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__20665) : pred__20664.call(null,reagent.ratom.Reaction,expr__20665)))){
return "rx";
} else {
if(cljs.core.truth_((pred__20664.cljs$core$IFn$_invoke$arity$2 ? pred__20664.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__20665) : pred__20664.call(null,reagent.ratom.Track,expr__20665)))){
return "tr";
} else {
return "other";
}
