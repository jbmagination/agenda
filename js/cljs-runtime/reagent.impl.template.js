...
var G__20482 = o;
(G__20482[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__20520__delegate = function (args){
...
return G__20520__delegate.call(this,args);};
...
return G__20520__delegate(args);
});
...
var G__20488 = jsprops;
(G__20488["defaultValue"] = value);

(G__20488["onChange"] = ((function (G__20488,v,value,on_change){
return (function (p1__20487_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__20487_SHARP_);
});})(G__20488,v,value,on_change))
);
...
var vec__20490 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20490,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20490,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20490,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___20538 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___20538 == null)){
} else {
var key_20540 = temp__5461__auto___20538;
(jsprops["key"] = key_20540);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__20495 = reagent.impl.template.__GT_NativeWrapper();
(G__20495["name"] = c);
...
var G__20496 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__20496) : reagent.impl.template.as_element.call(null,G__20496));
} else {
...
var len__4531__auto___20552 = arguments.length;
var i__4532__auto___20553 = (0);
while(true){
if((i__4532__auto___20553 < len__4531__auto___20552)){
args__4534__auto__.push((arguments[i__4532__auto___20553]));

var G__20554 = (i__4532__auto___20553 + (1));
i__4532__auto___20553 = G__20554;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq20498){
var G__20499 = cljs.core.first(seq20498);
var seq20498__$1 = cljs.core.next(seq20498);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20499,seq20498__$1);
});
...
break;
default:
var G__20559 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__20559;
continue;
...
var n__4408__auto___20565 = a.length;
var i_20566 = (0);
while(true){
if((i_20566 < n__4408__auto___20565)){
(a[i_20566] = reagent.impl.template.as_element((a[i_20566])));

var G__20568 = (i_20566 + (1));
i_20566 = G__20568;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___20569 = a.length;
var i_20570 = (0);
while(true){
if((i_20570 < n__4408__auto___20569)){
var val_20571 = (a[i_20570]);
if(((cljs.core.vector_QMARK_(val_20571)) && ((reagent.impl.template.key_from_vec(val_20571) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_20570] = reagent.impl.template.as_element(val_20571));

var G__20572 = (i_20570 + (1));
i_20570 = G__20572;
continue;
} else {
}
...
var ctx = ({});
var vec__20507 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20507,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20507,(1),null);
...
var G__20511 = (cljs.core.count(argv) - first_child);
switch (G__20511) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__20511){
